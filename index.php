		...
		<div class = "blockMain">			
			...
			<div class="block2" id="div2">
				<form autocomplete="off">
					...
					NIPT: <input type="text" id="nipt" name="nipt"><br>					
					Company address: <input type="text" id="companyAddress" name="companyAddress"><br><br>					
					<button id="submitEmp" onclick="addCompanyToDB()" type="button">Submit</button>
				</form>
			</div>
			<div class="block3" id="div3">
				<form autocomplete="off">
					...
					End Date: <input type="date" id="endDate" name="endDate"><br><br>					
					<button id="submitEmp" onclick="addPeriodsToDB()" type="button">Submit</button>
				</form>
			</div>			
		</div>
